...
foreach ($this->items as $item) {
    ...
    $picture    = HelperBackend::pictureShow('item-image',UPLOAD_URL.'banner'.DS.$item['picture']);
    ...
    <tr>
        ...
        <td class="text-center position-relative">' .   $item['ordering']            .'</td>
        <td class="text-center position-relative">' .   $item['type']  .'</td>
            ...
            <table class="table table-bordered table-hover text-nowrap btn-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Type</a></th>
